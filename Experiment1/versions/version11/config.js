...
// Version 11: Tiny Slider Checkbox Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 11
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 16 (Tiny Slider Checkbox) for Version 11
            return ExperimentConfig.conditions[10];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version11'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('INITIALIZING PARTICIPANT (VERSION 11):', participantId);
    ...
    ParticipantConfig.version = 'version11';

    console.log('PARTICIPANT INITIALIZED (VERSION 11):');
