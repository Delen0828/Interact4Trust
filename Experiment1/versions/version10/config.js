...
// Version 10: Checkbox Selection Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 10
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 11 (Checkbox Selection) for Version 10
            return ExperimentConfig.conditions[9];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version10'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('INITIALIZING PARTICIPANT (VERSION 10):', participantId);
    ...
    ParticipantConfig.version = 'version10';

    console.log('PARTICIPANT INITIALIZED (VERSION 10):');
