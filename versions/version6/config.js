...
// Version 6: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 6
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 5 (PI → Ensemble) for Version 1
            return ExperimentConfig.conditions[5];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version6'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 6):', participantId);
    ...
    ParticipantConfig.version = 'version6';
    
    console.log('✅ PARTICIPANT INITIALIZED (VERSION 6):');
