...
// Version 7: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 7
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 6 (Buggy Control) for Version 1
            return ExperimentConfig.conditions[6];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version7'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 7):', participantId);
    ...
    ParticipantConfig.version = 'version7';
    
    console.log('✅ PARTICIPANT INITIALIZED (VERSION 7):');
