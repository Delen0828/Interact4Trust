...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 2
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 1 (PI Plot) for Version 1
            return ExperimentConfig.conditions[1];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version2'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 2):', participantId);
    ...
    ParticipantConfig.version = 'version2';
    
    console.log('✅ PARTICIPANT INITIALIZED (VERSION 2):');
