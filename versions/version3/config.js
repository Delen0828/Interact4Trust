...
// Version 3: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 2 (Ensemble Plot) for Version 1
...
let ParticipantConfig = {
    ...
    version: 'version3'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 3):', participantId);
