...
// Version 8: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 7 (Bad Control) for Version 1
...
let ParticipantConfig = {
    ...
    version: 'version8'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 8):', participantId);
