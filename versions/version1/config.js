...
// Version 1: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 0 (Baseline) for Version 1
...
let ParticipantConfig = {
    ...
    version: 'version1'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 1):', participantId);
