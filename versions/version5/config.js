...
// Version 5: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 5
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 4 (PI Plot + Hover) for Version 1
            return ExperimentConfig.conditions[4];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version5'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 5):', participantId);
    ...
    ParticipantConfig.version = 'version5';
    
    console.log('✅ PARTICIPANT INITIALIZED (VERSION 5):');
