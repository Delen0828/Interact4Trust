...
// Version 9: Baseline Condition (Hardcoded)
...
const ExperimentConfig = {
    ...
    // Condition Assignment - HARDCODED FOR VERSION 9
    conditionAssignment: {
        getAssignedCondition: function() {
            // HARDCODED: Always return condition 8 (Combined PI + Ensemble) for Version 1
            return ExperimentConfig.conditions[8];
        }
    },
...
let ParticipantConfig = {
    ...
    version: 'version9'  // Added version tracking
};

// Initialize participant configuration
function initializeParticipant(participantId) {
    console.log('🚀 INITIALIZING PARTICIPANT (VERSION 9):', participantId);
    ...
    ParticipantConfig.version = 'version9';
    
    console.log('✅ PARTICIPANT INITIALIZED (VERSION 9):');
