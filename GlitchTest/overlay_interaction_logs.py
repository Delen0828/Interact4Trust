...
def plot_condition_overlay(
    ...
    total_points, event_types = draw_condition_overlay(
        ax=ax,
        traces=traces,
    ...
    fig.text(
        0.5,
        0.015,
        f"{len(traces)} traces, {total_points} points",
        ha="center",
        fontsize=8,
        color="white",
...
def plot_combined_overlay(
    ...
    combined_points, all_event_types = draw_condition_overlay(
        ax=ax,
        traces=traces,
        screenshot_path=screenshot_path,
        point_alpha=point_alpha,
    ...
    fig.text(
        0.5,
        0.015,
        f"{len(traces)} traces across selected conditions, {combined_points} points",
        ha="center",
        fontsize=8,
        color="white",
        bbox={"facecolor": "black", "alpha": 0.35, "pad": 3},
    ...
    legend_handles = build_legend_handles(all_event_types)
    if legend_handles:
        fig.legend(
            handles=legend_handles,
            loc="lower center",
