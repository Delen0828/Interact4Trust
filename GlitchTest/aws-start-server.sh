...
pm2 start "php -S 0.0.0.0:8003 -t dist" --name php-server-glitch
...
pm2 start "cloudflared tunnel --no-autoupdate --url http://127.0.0.1:8003" \
    --name cloudflared-tunnel-glitch \
